...
if (isset($_POST['add_song'])) {
    ...
    $detailid = mysqli_real_escape_string($db, $_POST['id']);
    ...
    if (count($errors) == 0) {
        ...
        $query = "INSERT INTO details_edit (name, email, songname, songname1, album, artist, lyricist, composer, musician, link, link1, genre, meaning, confirmed, detailid) 
          VALUES('$name', '$email', '$songname','$songname1', '$album','$artist','$lyricist', '$composer','$musician','$link','$link1','$genre','$meaning', 'unconfirmed','$detailid' )";
