...
<head>
    ...
    <title>Edit Song Details | Sinhala Song Details</title>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="center gap fade-down section-heading">
                                    <h2 class="main-title">Edit song details</h2>
                                    <hr>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-8 fade-up">
                        ...
                        <form method="post" id="addsong" action="edit-song-db.php">
                            ...
                            <p>3) Name of the song</p>
                            <div id="messageSongName" class="bolder"></div>
                            <input type="text" name="songname" id="songname" placeholder="Name of the Song" value= "<?php echo $_SESSION['songname']; ?>" />
                            
                            <p>4) Other names of the song</p>
                            <input type="text" name="songname1" id="songname1" placeholder="Other name of the song (if any)" value= "<?php echo $_SESSION['songname1']; ?>"/>
                            
                            <p>5) Album</p>
                            <input type="text" name="album" id="album" placeholder="Album" value= "<?php echo $_SESSION['album']; ?>" />
                            
                            <p>6) Artist</p>
                            <div id="messageArtistName" class="bolder"></div>
                            <input type="text" name="artist" id="artist" placeholder="Artist or Band" value= "<?php echo $_SESSION['artist']; ?>" />
                            
                            <p>7) Lyricist</p>
                            <div id="messageLyricistName" class="bolder"></div>
                            <input type="text" name="lyricist" id="lyricist" placeholder="Lyricist" value= "<?php echo $_SESSION['lyricist']; ?>" />
                            
                            <p>8) Composer</p>
                            <div id="messageComposerName" class="bolder"></div>
                            <input type="text" name="composer" id="composer" placeholder="Composer" value= "<?php echo $_SESSION['composer']; ?>" />
                            
                            <p>9) Musician</p>
                            <input type="text" name="musician" id="musician" placeholder="Musician" value= "<?php echo $_SESSION['musician']; ?>" />
                            
                            <p>10) Orginal Song</p>
                            <input type="text" name="link" id="link" placeholder="Orginal Song Link" value= "<?php echo $_SESSION['link']; ?>" />
                            
                            <p>11) New Version</p>
                            <input type="text" name="link1" id="link1" placeholder="New Version Link (If any)" value= "<?php echo $_SESSION['link1']; ?>"/>
                            
                            <p>12) Genre</p>
                            <input type="text" name="genre" id="genre" placeholder="Genre" value= "<?php echo $_SESSION['genre']; ?>"/>
                            
                            <p>13) Meaning or Background Story</p>
                            <textarea name="meaning" id="meaning" placeholder="Meaning or background story in short" value= "<?php echo $_SESSION['meaning']; ?>"></textarea>
                    ...
                    <div class="col-md-8 fade-up">
                        <p>All details are user submitted. There may be small mistakes. Your inputs will improve the quality of this database. Thank you for editing information here. </p>
                    </div><!-- col -->
                </div><!-- row -->
                <div class="gap"></div>
            </div>
